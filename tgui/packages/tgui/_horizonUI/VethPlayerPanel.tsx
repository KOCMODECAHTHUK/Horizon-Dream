...
const TextOrNA = (props: { text?: string } & ComponentProps<typeof Box>) => {
      ...
      <Stack>
        <Stack.Item grow>
          <Button
            fluid
            my={0.5}
            content="All Verb Panel"
            onClick={() => handleAction('allVerbsPanel')}
          />
          <Button
            fluid
            my={0.5}
...
export const VethPlayerPanel = (_props) => {
  ...
  return (
    <Box>
      <Window title="Player Panel Veth" theme="ntos_darkmode" width={1000} height={640}>
        <Window.Content>
          <Stack fill vertical>
            <Stack.Item>
              <AdminHelpers />
