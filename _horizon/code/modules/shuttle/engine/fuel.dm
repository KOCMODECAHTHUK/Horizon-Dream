...
/obj/machinery/power/shuttle_engine/ship/fueled
	...
	var/obj/machinery/atmospherics/components/unary/fueled_engine_heater/connected_heater
...
/obj/machinery/power/shuttle_engine/ship/fueled/proc/try_link_heater()
	...
	var/obj/machinery/atmospherics/components/unary/fueled_engine_heater/candidate_heater = locate() in candidate_turf
	if(!candidate_heater || candidate_heater.dir != dir)
		return FALSE
	on_heater_link(candidate_heater)

/// Called when the engine is linked to a heater; must call parent first.
/obj/machinery/power/shuttle_engine/ship/fueled/proc/on_heater_link(obj/machinery/atmospherics/components/unary/fueled_engine_heater/connecting)
...
/obj/machinery/power/shuttle_engine/ship/fueled/post_machine_initialize()
	. = ..()
	try_link_heater()
...
/obj/machinery/power/shuttle_engine/ship/fueled/return_fuel()
	if(fuel_type)
		if(connected_heater)
			...
			return connected_heater?.air_contents.moles[fuel_type] || 0
		else
			return 0
...
/obj/machinery/power/shuttle_engine/ship/fueled/proc/consume_fuel(amount)
	...
	if(fuel_type)
		connected_heater.air_contents.assert_gas(fuel_type)
		var/avail_moles = connected_heater.air_contents.moles[fuel_type]
...
/obj/machinery/power/shuttle_engine/ship/fueled/examine(mob/user)
	. = ..()
	. += "The engine heater's gas dial reads [consume_fuel()] moles of gas.<br>"
